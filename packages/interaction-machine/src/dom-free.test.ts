...
/**
 * DOM-free invariant. `@vision-control/interaction-machine` is
 * `platform:isomorphic` and consumed by Node packages (daemon). It MUST NOT
 * reference any browser-only global. See the element-identity sibling test for
 * the full rationale.
 */
...
describe("interaction-machine is DOM-free", () => {
