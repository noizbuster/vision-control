 ...
 *   reparent-element → parent + sibling-order assertions (under targetParent at targetIndex)
 *
...
function assertionsForOperation(operation: Operation): AssertionEntry[] {
  switch (operation.kind) {
    ...
    case "grid-reorder":
      return buildGridReorderAssertions(operation);

    case "grid-span":
      return buildGridSpanAssertions(operation);
